    ...
    <div class="navbar  bg-[#193654] shadow-sm text-white">
        ...
        <div class="flex-none">
            <ul class="menu menu-horizontal px-1">
                <li><a href="/user-register">Registro usuarios</a></li>
                <li><a href="/table-users">Usuarios</a></li>
            </ul>
        </div>
    </div>
    {{ $slot }}
    <footer class="footer footer-horizontal footer-center bg-[#193654] text-base-content rounded p-10 text-white">
        <nav class="grid grid-flow-col gap-4">
            <a href="https://www.linkedin.com/in/nicole-dayana-vega" target="_blank" class="link link-hover">Linkedin</a>
            <a href="https://github.com/NVega04/syscom" target="_blank" class="link link-hover">GitHub</a>
        </nav>
        <nav>
